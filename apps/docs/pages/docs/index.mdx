...
## Repository
Skylark is a Centralized Repository dedicated to securely storing your system logs in a database. This Dentralized Repository is a secure space for your system logs, ensuring their safety and providing a straightforward platform for easy retrieval when needed.
