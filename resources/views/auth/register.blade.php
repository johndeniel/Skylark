                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="name" 
                                       ...
                                       required
                                       autofocus
                                       class="w-full px-4 py-3 border rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200 @error('name') border-red-300 @enderror"
                                       value="{{ old('name') }}" 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="password_confirmation" 
                                       ...
                                       type="password" 
                                       required
                                       class="w-full px-4 py-3 border rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="sex" 
                                        name="sex" 
                                        required
                                        class="w-full px-4 py-3 border rounded-lg appearance-none bg-white focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200 @error('sex') border-red-300 @enderror">
                                    <option value="" disabled {{ old('sex') === null ? 'selected' : '' }}>Select your gender</option>
